<template>
  <nav class="flex z-50">
    <div class="w-full p-4 z-50">
      <div class="max-w-screen-xl mx-auto z-50">
        <div class="relative flex items-center justify-between">
          <div class="absolute inset-y-0 right-0 flex items-center sm:hidden">
            <!-- Mobile menu button-->
            <button type="button" @click="menuOpen = !menuOpen" class="inline-flex items-center justify-center p-2 rounded-md  hover:text-black hover:bg-midcent-blush focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white menu" aria-controls="mobile-menu" aria-expanded="false">
